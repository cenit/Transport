///////////////////////////////////////////////////////////////////////////////
//////////////////// TransEllipseWin2 window class definition /////////////////
///////////////////////////////////////////////////////////////////////////////

#ifndef TELIWIN2_HPP
#define TELIWIN2_HPP

class TransEllipseWin2 : public Window
{
        DisplayDevice *opDev;
        ...
        float  x[4],xp[4],r12[4],y[4],yp[4],r34[4],d[4],dp[4];
        char   infoline[4][80];
    ...
    public:
        TransEllipseWin2(int, LPCSTR, RECT, Window *,
                        TransGrafFile *, BOOL, BOOL, int);
        ~TransEllipseWin2(VOID);
        VOID GetDimensions(char *, char *, char *, char *, char *);
        VOID TransferEllipsePar(float, float, float, char *);
