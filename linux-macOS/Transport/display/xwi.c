...
/* Caution: compile with cc/noopt xwi                                         /
/*****************************************************************************/
...
int  getinter_(void);
void getwindim_(int *iw, int *ih);
void getscreenres_(int *iw, int *ih);
...
static void doLoadFont(void)
{
   ...
   static char FontName0[] = "*-HELVETICA-MEDIUM-R-NORMAL--*-80-*" ;
   static char FontName1[] = "*-HELVETICA-MEDIUM-R-NORMAL--*-100-*" ;
   static char FontName2[] = "*-HELVETICA-MEDIUM-R-NORMAL--*-120-*" ;
...
void getwindim_(int *iw, int *ih)
{
   Window       root;
   unsigned int b, d;
   XGetGeometry(dpy,window1,&root,&xr,&yr,&wr,&hr,&b,&d);
   *iw = wr;
   *ih = hr;
}
/*----------------------------------------------------------------------------*/
