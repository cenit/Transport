C
C     COMMONS FOR PROGRAM INPUT (VERSION MS-FORTRAN V5.1)
C
      COMMON          IDUM(100)
      COMMON  /XXX/   CARDS(800)
      CHARACTER*80    CARDS
     ...
     A                NWORD, NVARY, DATUM(30), VARY(30)
      INTEGER         VARY
      LOGICAL         FLUSH
      COMMON /BLO41A/ LABLE, IMAGE(80)
      CHARACTER       IMAGE*1, LABLE*4
      INTEGER         IMGX(20)
      EQUIVALENCE     (IMAGE,IMGX)
     ...
     A                PAR1, PAR2
      ...
      COMMON /BLOC70/ LENG(1000), MULT(1001)
      COMMON /BLO70A/ ICOMM(4000)
      CHARACTER*1     ICOMM
C--------------------------------- EOF ----------------------------------------
